...
// FIX: Added optional asChild typing and handled Base UI rendering
function AlertDialogTrigger({ 
  ...
  return (
    <AlertDialogPrimitive.Trigger 
      ...
      // 1. Disable the native button check so it allows custom elements/components
      nativeButton={!asChild}
      // 2. If asChild is true, use a render function to pass props through to the custom child element
      render={asChild ? (props) => <span {...props} style={{ display: "contents" }} /> : render}
      {...props} 
    />
  )
}
